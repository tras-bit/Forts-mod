-- ============================================================
--  Military Pack: ВЕТРЯК, ВТОРОЙ УРОВЕНЬ (v3.8)
--
...
--    Head    — ротор (5 лопасти), его крутит САМ
--              ДВИЖОК (UserData = 50)               head2.png
--
...
Mass = 80.0
HitPoints = 105.0
EnergyProductionRate = 67.5
MetalProductionRate = 0.0
EnergyStorageCapacity = 0.0
MetalStorageCapacity = 0.0

MinWindEfficiency = 0.3
MinWindNoCrossFlow = 0.35
MinWindCrossFlow = 0.4
MaxWindHeight = 800
MinTestDistance = 25
MaxTestDistance = 600
MinWindAngle = -10
MaxWindAngle = 10
MaxRotationalSpeed = 8          -- супер-турбина крутится быстрее
...
Sprites =
{
	...
	},
	{
		...
		States =
		{
			Normal = { Frames = { { texture = path .. "/devices/media/windmill/head2.png" }, mipmap = true, }, },
		},
	},
}
