-- ============================================================
--  Military Pack: рескин ВАНИЛЬНОЙ шахты 2 (M1 style, v4.6)
--  Текстура ровно 640x310, коллизия аккуратная
-- ============================================================

dofile("devices/mine2.lua")
...
local V_W, V_H, V_OX, V_OY = 93.25, 49.0, 0.0, 0.0
...
local tex   = path .. "/devices/media/mine2.png"
